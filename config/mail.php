...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Öffentliche Kontakt-E-Mail (Footer, mailto)
    |--------------------------------------------------------------------------
    |
    | Kann vom SMTP-Absender (MAIL_FROM_ADDRESS) abweichen, z. B. persönliches
    | Postfach für Antworten, während der Versand über redaktion@ läuft.
    | Standard: gleicher Wert wie MAIL_FROM_ADDRESS.
    |
    */
